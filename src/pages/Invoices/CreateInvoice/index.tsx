                                        ...
                                        <Row>
                                            <Col lg={4}>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="mb-2">
                                                        <textarea className="form-control" id="companyAddress" placeholder="Company Address" defaultValue="" rows={3}/>
                                    ...
                                    <Card.Body className="p-4">
                                        <Row className="g-3">
                                            <Col lg={3} sm={6}>
                                                ...
                                                <Form.Control type="text" id="invoicenoInput" placeholder="Invoice No" defaultValue="#TN25000355" />
                                            </Col>
                                            <Col lg={3} sm={6}>
                                                <div>
                                    ...
                                    <Card.Body className="p-4 border-top border-top-dashed">
                                        <Row>
                                            <Col lg={4} sm={6}>
                                                ...
                                                <div className="mb-2">
                                                    <textarea className="form-control" id="billingAddress" placeholder="Address" defaultValue="" rows={3}/>
                                                    <div className="invalid-feedback">
                                                        Please enter a address
                                                    </div>
                                                </div>
                                            ...
                                            <Col sm={6} className="ms-auto">
                                                <Row>
                                                    <Col lg={8}>
                                                        ...
                                                        <div className="mb-2">
                                                            <textarea className="form-control" id="shippingAddress" placeholder="Address" defaultValue="" rows={3}/>
                                                            <div className="invalid-feedback">
                                                                Please enter a address
                                                            </div>
                                                        </div>
                                                        ...
                                                        <td className="p-0" colSpan={2}>
                                                            <Table className="table-borderless table-sm table-nowrap align-middle mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <th scope="row">Discount <small className="text-muted">(TONER)</small></th>
                                                                        <td>
